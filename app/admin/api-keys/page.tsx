    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-brand-primary hover:bg-brand-primary/90 text-black font-bold rounded-lg text-sm transition-colors"
        >
          <Plus size={16} />
          创建 API Key
        </button>
      ...
      {newKey && (
        <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-5">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {copied ? <Check size={16} className="text-green-400" /> : <Copy size={16} className="text-green-400" />}
            </button>
          </div>
          <button
      ...
      <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5">
        ...
        <div className="bg-black/30 rounded-lg p-3 font-mono text-xs text-zinc-400">
          ...
          <p>
            curl -H &quot;Authorization: Bearer <span className="text-brand-primary">ak_your_key_here</span>&quot; \
          </p>
          <p className="pl-5">
            {typeof window !== 'undefined' ? window.location.origin : 'https://your-domain.com'}/api/v1/assets
          </p>
        </div>
        <div className="mt-3 text-xs text-zinc-500 space-y-1">
          <p>可用端点：<code className="text-zinc-400">GET /api/v1/assets</code>、<code className="text-zinc-400">GET /api/v1/assets/:id</code>、<code className="text-zinc-400">GET /api/v1/assets/:id/download</code>、<code className="text-zinc-400">GET /api/v1/categories</code></p>
        </div>
      </div>
                ...
                <td className="p-4">
                  <div className="flex flex-wrap gap-1">
                    ...
                    {key.permissions.length > 3 && (
                      <span className="text-[10px] text-zinc-500">+{key.permissions.length - 3}</span>
                    )}
                  </div>
                </td>
                <td className="p-4">
