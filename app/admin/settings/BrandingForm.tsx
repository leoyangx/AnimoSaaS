  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-display font-black tracking-tight text-text-primary">品牌与视觉</h1>
          <p className="text-text-secondary text-sm mt-1">自定义您的品牌名称、标语、Logo 以及全局色彩风格。</p>
        </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">网站标题</label>
            <input 
              type="text" 
              value={config.title} 
          ...
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">网站 Slogan</label>
            <input 
              type="text" 
              value={config.slogan} 
          ...
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">主色调 (Accent Color)</label>
          ...
          <div className="space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">版权水印文字</label>
            <input 
              type="text" 
          ...
          <div className="md:col-span-2 space-y-3">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">底部版权信息</label>
            <input 
              type="text" 
              value={config.footer} 
