  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-display font-black tracking-tight text-text-primary">存储引擎</h1>
          <p className="text-text-secondary text-sm mt-1">配置 AList、123云盘等第三方存储服务，实现素材的自动化解析与下载。</p>
        </div>
      ...
      >
        ...
        <div className="glass-card p-8 space-y-6">
              ...
              onClick={async () => {
                ...
                try {
                  const res = await fetch('/api/admin/test-storage', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ type: 'alist', ...config }),
                  });
                  const data = await res.json();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">AList 地址</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">API Token</label>
              <input 
                type="password" 
        ...
        <div className="glass-card p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">AccessToken</label>
              <input 
                type="password" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">挂载根目录</label>
              <input 
                type="text" 
        ...
        <div className="glass-card p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">解析接口地址</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-text-secondary">API Key / Token</label>
              <input 
                type="password" 
