 ...
 */
export function validateCsrfDouble(cookieToken: string | undefined, headerToken: string | null): boolean {
 ...
 */
export function validateCsrfFromRequest(request: Request & { cookies?: { get(name: string): { value: string } | undefined } }): boolean {
